...
Sparkle updates are generated by the GitHub release workflow. Tag `vX.Y.Z` to
build `Sgommello-X.Y.Z.dmg`, sign the appcast with the shared
`SPARKLE_ED_PRIVATE_KEY` secret and upload both files to the release.
