...
### Changed
- Nuove icone menu bar procedurali: faccia di Sgommello quando il monitoraggio è attivo e retro/culetto quando è in pausa.
- Menu barra semplificato con voci più brevi: "Impostazioni", "Informazioni" e "Update".
- Rimosso "Mostra ora (test)" dal menu barra: il test resta disponibile dentro Impostazioni.
